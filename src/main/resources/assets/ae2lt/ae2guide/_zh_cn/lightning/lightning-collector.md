...
| 安装未完成催化的电鸣水晶 | 随催化进度在「起始产量」与「最终产量」之间线性增长，产量存在少量随机浮动 |
...
* 仅在收集器被**自然闪电**（即产生极高压闪电的雷击）命中时，并且网络中有足够的容量存储产生的闪电时，水晶才会获得催化值。人工闪电不会增加催化进度
...
* 若不愿等待自然雷暴，可使用 [大气电离仪](../machines/atmospheric-ionizer.md) 消耗**雷暴凝核**强制触发雷暴天气

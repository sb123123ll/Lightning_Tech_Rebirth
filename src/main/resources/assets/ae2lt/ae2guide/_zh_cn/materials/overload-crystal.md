...
> 挖掘时，**精准采集**可保留有瑕、开裂、损坏等级的母岩。**无瑕的过载水晶母岩**被挖掘时会掉落为有瑕母岩。
...
<ItemLink id="ae2:growth_accelerator" />（催生器）对过载水晶芽同样有效。在母岩周围放置催生器可显著提升水晶的生长速率。
...
如果过载水晶块数量不足，可以用简化结构生产除无瑕外的 3 个等级母岩：

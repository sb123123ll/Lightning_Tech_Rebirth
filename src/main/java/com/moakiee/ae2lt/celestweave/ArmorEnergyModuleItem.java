...
public final class ArmorEnergyModuleItem extends Item implements OverloadDeviceModuleItem {
   ...
   public long armorCapacityFe() {
      return this.armorCapacityFe;
   }

   public long capacityFe() {
      return this.legacyCapacityFe;
   }
   ...
   public boolean accepts(DeviceKind deviceKind, DeviceSlotType slotType) {
      return this.acceptableDevices().contains(deviceKind) && acceptableSlotFor(deviceKind) == slotType;
   }
   ...
   public List<DeviceCapability> capabilities(ItemStack stack) {
      return List.of(new DeviceCapability.EnergyCapacity(this.legacyCapacityFe));
   }

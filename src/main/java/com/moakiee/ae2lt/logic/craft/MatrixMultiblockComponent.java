...
public enum MatrixMultiblockComponent {
   ...
   public boolean isMainCore() {
      return this == STABLE_MAIN_CORE || this == QUANTUM_MAIN_CORE || this == OVERLOAD_MAIN_CORE || this == MULTIDIMENSIONAL_MAIN_CORE;
   }

   public boolean isCraftingUnit() {
      return switch (this) {
         case BLANK_UNIT, THREAD_UNIT_T1, THREAD_UNIT_T2, AMPLIFIER_UNIT, THERMAL_CONTROL_UNIT_T1, THERMAL_CONTROL_UNIT_T2 -> true;
         default -> false;
      };
   }

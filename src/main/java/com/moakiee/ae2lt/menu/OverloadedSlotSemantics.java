...
public final class OverloadedSlotSemantics {
   ...
   public static final SlotSemantic[] CONFIG_PATTERN = new SlotSemantic[]{OL_1, OL_3, OL_5, OL_7};
   public static final SlotSemantic[] STORAGE_PATTERN = new SlotSemantic[]{OL_2, OL_4, OL_6, OL_8};

...
public class LightningAssemblyChamberScreen extends AEBaseScreen<LightningAssemblyChamberMenu> {
   ...
   public LightningAssemblyChamberScreen(LightningAssemblyChamberMenu menu, Inventory playerInventory, Component title, ScreenStyle style) {
      ...
      this.autoExportButton
         .setTooltipOn(
            List.of(Component.m_237115_("ae2lt.gui.lightning_assembly.auto_export.title"), Component.m_237115_("ae2lt.gui.lightning_assembly.auto_export.on"))
         );
      this.autoExportButton
         .setTooltipOff(
            List.of(Component.m_237115_("ae2lt.gui.lightning_assembly.auto_export.title"), Component.m_237115_("ae2lt.gui.lightning_assembly.auto_export.off"))
         );
      this.addToLeftToolbar(this.autoExportButton);
      this.configureOutputButton = new ActionButton(ActionItems.TERMINAL_SETTINGS, () -> this.switchToScreen(new LightningAssemblyOutputConfigScreen(this)));
      this.configureOutputButton.m_93666_(Component.m_237115_("ae2lt.gui.lightning_assembly.configure_output"));
   ...
   private List<Component> getCompatibleUpgrades() {
      ...
      list.addAll(Upgrades.getTooltipLinesForMachine(((LightningAssemblyChamberMenu)this.f_97732_).getHost().getUpgrades().getUpgradableItem()));
      return list;
   }

   protected void updateBeforeRender() {
      super.updateBeforeRender();
      this.autoExportButton.setState(((LightningAssemblyChamberMenu)this.f_97732_).isAutoExportEnabled());
      this.configureOutputButton.setVisibility(((LightningAssemblyChamberMenu)this.f_97732_).isAutoExportEnabled());
   }
}

...
public class CrystalCatalyzerEnergyBar extends AbstractWidget implements ITooltip {
   ...
   protected void m_87963_(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
      ...
      long stored = Math.min(Math.max(0L, this.menu.getStoredEnergy()), capacity);
   ...
   public List<Component> getTooltipMessage() {
      return List.of(
         Component.m_237110_("ae2lt.gui.crystal_catalyzer.energy.tooltip", new Object[]{this.menu.getStoredEnergy(), this.menu.getEnergyCapacity()})
      );
   }

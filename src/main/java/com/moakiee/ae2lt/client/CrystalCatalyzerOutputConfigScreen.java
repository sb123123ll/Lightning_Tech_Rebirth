...
public class CrystalCatalyzerOutputConfigScreen extends AESubScreen<CrystalCatalyzerMenu, CrystalCatalyzerScreen> {
   ...
   public CrystalCatalyzerOutputConfigScreen(CrystalCatalyzerScreen parent) {
      ...
      MutableComponent label = Component.m_237115_("block.ae2lt.crystal_catalyzer");
      ...
      OutputSidesClearButton clear = new OutputSidesClearButton(
         Component.m_237115_("ae2lt.gui.crystal_catalyzer.output_side.clear"), button -> ((CrystalCatalyzerMenu)this.f_97732_).clientClearOutputSides()
      );
   ...
   protected void updateBeforeRender() {
      ...
      this.frontButton.setOn(((CrystalCatalyzerMenu)this.f_97732_).isOutputSideEnabled(RelativeSide.FRONT));
      this.backButton.setOn(((CrystalCatalyzerMenu)this.f_97732_).isOutputSideEnabled(RelativeSide.BACK));
      this.leftButton.setOn(((CrystalCatalyzerMenu)this.f_97732_).isOutputSideEnabled(RelativeSide.LEFT));
      this.rightButton.setOn(((CrystalCatalyzerMenu)this.f_97732_).isOutputSideEnabled(RelativeSide.RIGHT));
      this.topButton.setOn(((CrystalCatalyzerMenu)this.f_97732_).isOutputSideEnabled(RelativeSide.TOP));
      this.bottomButton.setOn(((CrystalCatalyzerMenu)this.f_97732_).isOutputSideEnabled(RelativeSide.BOTTOM));
   }
   ...
   private LightningSimulationOutputButton addSideButton(String widgetId, RelativeSide side, String labelKey) {
      LightningSimulationOutputButton button = new LightningSimulationOutputButton(
         Component.m_237115_(labelKey), press -> ((CrystalCatalyzerMenu)this.f_97732_).clientToggleOutputSide(side)
      );
   ...
   private void refreshButtonDisplays() {
      CrystalCatalyzerBlockEntity host = ((CrystalCatalyzerMenu)this.f_97732_).getHost();

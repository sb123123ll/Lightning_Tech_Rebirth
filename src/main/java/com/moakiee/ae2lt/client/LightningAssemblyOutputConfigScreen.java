...
public class LightningAssemblyOutputConfigScreen extends AESubScreen<LightningAssemblyChamberMenu, LightningAssemblyChamberScreen> {
   ...
   public LightningAssemblyOutputConfigScreen(LightningAssemblyChamberScreen parent) {
      ...
      MutableComponent label = Component.m_237115_("block.ae2lt.lightning_assembly_chamber");
      ...
      OutputSidesClearButton clear = new OutputSidesClearButton(
         Component.m_237115_("ae2lt.gui.lightning_assembly.output_side.clear"),
         button -> ((LightningAssemblyChamberMenu)this.f_97732_).clientClearOutputSides()
      );
   ...
   protected void updateBeforeRender() {
      ...
      this.frontButton.setOn(((LightningAssemblyChamberMenu)this.f_97732_).isOutputSideEnabled(RelativeSide.FRONT));
      this.backButton.setOn(((LightningAssemblyChamberMenu)this.f_97732_).isOutputSideEnabled(RelativeSide.BACK));
      this.leftButton.setOn(((LightningAssemblyChamberMenu)this.f_97732_).isOutputSideEnabled(RelativeSide.LEFT));
      this.rightButton.setOn(((LightningAssemblyChamberMenu)this.f_97732_).isOutputSideEnabled(RelativeSide.RIGHT));
      this.topButton.setOn(((LightningAssemblyChamberMenu)this.f_97732_).isOutputSideEnabled(RelativeSide.TOP));
      this.bottomButton.setOn(((LightningAssemblyChamberMenu)this.f_97732_).isOutputSideEnabled(RelativeSide.BOTTOM));
   }
   ...
   private LightningSimulationOutputButton addSideButton(String widgetId, RelativeSide side, String labelKey) {
      LightningSimulationOutputButton button = new LightningSimulationOutputButton(
         Component.m_237115_(labelKey), press -> ((LightningAssemblyChamberMenu)this.f_97732_).clientToggleOutputSide(side)
      );
   ...
   private void refreshButtonDisplays() {
      LightningAssemblyChamberBlockEntity host = ((LightningAssemblyChamberMenu)this.f_97732_).getHost();

...
public final class RailgunChargeRampSound extends AbstractTickableSoundInstance {
   ...
   public RailgunChargeRampSound(LocalPlayer player) {
      super((SoundEvent)ModSounds.RAILGUN_CHARGE_RAMP.get(), SoundSource.PLAYERS, RandomSource.m_216327_());
      this.player = player;
   ...
   public void m_7788_() {
      ...
      if (!this.player.m_213877_() && this.player.m_6084_() && mc.f_91073_ != null) {
         ...
         if (RailgunChargeSoundPhase.fromChargeTicks(chargeTicks, 40L) == RailgunChargeSoundPhase.SUSTAIN) {
            this.requestStop();
         }
         ...
         if (this.active) {
            ...
            this.f_119573_ = 0.75F * ((float)this.fadeIn / 3.0F);
         } else if (this.fadeOut > 0) {
            this.fadeOut--;
            this.f_119573_ = 0.75F * ((float)this.fadeOut / 3.0F);
         } else {
            this.f_119573_ = 0.0F;
            this.m_119609_();
         }

...
public class LightningAssemblyEnergyBar extends AbstractWidget implements ITooltip {
   ...
   public List<Component> getTooltipMessage() {
      return List.of(
         Component.m_237110_("ae2lt.gui.lightning_assembly.energy.tooltip", new Object[]{this.menu.getStoredEnergy(), this.menu.getEnergyCapacity()})
      );
   }
